...
function My_Nav() {
    return (
        <nav className="tw-flex tw-w-full tw-justify-center tw-items-center tw-font-extrabold tw-flex-wrap tw-py-5 tw-bg-primary-200 tw-shadow-sm tw-shadow-primary-200">
